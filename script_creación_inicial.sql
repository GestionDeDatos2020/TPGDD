...
BEGIN TRANSACTION
	--claves para la tabla Habitacion
	...
	--claves para la tabla Ruta AEREA
...
-- CONSTRAINS O RESTRICCIONES NECESARIAS PARA EL CORRECTO FUNCIONAMIENTO DE LAS TABLAS
BEGIN TRANSACTION
...
INSERT INTO COVID_20.CIUDAD (Ciudad_Nombre)
	...
	SELECT distinct RUTA_AEREA_CIU_ORIG 
		...
		order by 1
---------------------------------------------- MIGRACIOS DE LA TABLA RUTA AEREA
...
---------------------------------------------- MIGRACIOS DE LA TABLA TIPO_HABITACION
...
---------------------------------------------- MIGRACIOS DE LA TABLA FACTURA 

--MIGRACION DE LAS FACTURAS RELACIONADAS CON LAS ESTADIAS
...
-- MIGRACION DE LAS FACTURAS RELACIONADAS CON LOS PASAJES		  
INSERT INTO COVID_20.FACTURA (Factura_NRO, Factura_Fecha, Factura_Importe,
